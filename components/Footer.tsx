...
export function Footer() {
  ...
  return <footer className="footer"><div className="site-container">
    <div className="footer-main">
      <div className="footer-brand"><a href="#home" className="wordmark light"><strong>POP HAUS</strong><span>RENTALS · BALLOONS · EVENTS</span></a><p>Two businesses. One goal:<br/><em>Make your celebration unforgettable.</em></p>{/* TODO: Add the real Pop Haus social profile URLs. */}<div className="social-links"><span aria-label="Instagram link coming soon"><Icon name="instagram"/></span><span aria-label="Facebook link coming soon"><Icon name="facebook"/></span></div></div>
