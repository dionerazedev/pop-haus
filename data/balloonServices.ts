...
export const installations: BalloonService[] = [
  ...
  { name: "Custom Balloon Designs", detail: "Custom installations tailored to your space and style" }
];

export const garlands: BalloonService[] = [
  { name: "Deluxe Garland", price: "Starting at $25 per ft", detail: "5\", 12\", 16\" and 24\" balloons · 12 ft minimum" },
  { name: "Deluxe Starburst", price: "Starting at $27 per ft", detail: "Mixed balloon sizes with starburst foil accents · 12 ft minimum" },
  { name: "Deluxe Floral", price: "Starting at $30 per ft", detail: "Mixed balloon sizes with premium florals · 12 ft minimum" }
];
